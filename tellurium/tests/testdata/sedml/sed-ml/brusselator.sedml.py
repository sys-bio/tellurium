"""
    ...
    auto-generated code (2016-02-29T17:11:01)
    sedmlDoc: L1V1  
...
#  - plot1 (The Lorenz Attractor (phase plot x vs y))
#  - plot1 (The Lorenz Attractor (phase plot x vs z))
#  - plot1 (The Lorenz Attractor (phase plot y vs z))
