...
import tellurium.tellurium.tecombine
import tellurium.tellurium.tellurium as te
from tellurium.tellurium.sedml.old import tesedml
...
class tePhrasedml(object):
    ...
    def exportAsCombine(self, outputpath):
        ...
        tellurium.tellurium.tecombine.export(outputpath, self.antimonyStr, self.phrasedmlStr)
