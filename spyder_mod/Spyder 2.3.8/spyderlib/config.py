            ...
            ('console',
             {
              ...
              'pythonstartup' : r'%WINPYDIR%\python-2.7.10\lib\site-packages\spyderlib\scientific_startup.py',
            ...
            ('ipython_console',
             {
              ...
              'startup/run_lines': 'import antimony, import sbml2matlab, import teplugins, import numpy, import scipy, import matplotlib, import roadrunner, import tellurium as te',
            ...
            ('editor',
             {
              ...
              'recent_files' : [u'%WINPYDIR%\\python-2.7.10\\lib\\site-packages\\tellurium\\example1.py'],
              'filenames' : [u'%WINPYDIR%\\python-2.7.10\\lib\\site-packages\\tellurium\\example1.py']
              }),
            ('historylog',
             {
              'enable': True,
