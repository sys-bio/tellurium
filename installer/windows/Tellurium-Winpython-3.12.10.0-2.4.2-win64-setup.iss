...
#define Py "Python"
#define PyV "3.12"
#define PyVer "3.12.10.amd64"
#define CurrentVer ""
#define TelluriumVersion "2.4.2"
#define Tellurium_Winpython "TW-3.12.10.1-win64-2.4.2"
...
Source: "./settings6.0.4/*"; DestDir: "{app}/settings"; Flags: ignoreversion recursesubdirs createallsubdirs onlyifdoesntexist uninsneveruninstall
...
Source: "./Tellurium_splash_installer_updated.bmp"; DestName: "Tellurium_splash_installer_updated.bmp"; Flags: dontcopy nocompression
...
begin
  ...
  ExtractTemporaryFile('Tellurium_splash_installer_updated.bmp');
  BitmapImage1.Bitmap.LoadFromFile(ExpandConstant('{tmp}') + '\Tellurium_splash_installer_updated.bmp');
