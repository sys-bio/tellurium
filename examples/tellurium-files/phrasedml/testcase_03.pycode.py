"""
    ...
    auto-generated code (2016-03-01T09:25:02)
    sedmlDoc: L1V2  
    workingDir: /tmp/tmp8nyG35_sedml/_te_testcase_03
...
__mod2_doc = libsbml.readSBMLFromString(__mod2_sbml)
...
for k in range(len(plot_0_0_0)):
    if k == 0:
        plt.plot(plot_0_0_0[k], plot_0_0_1[k], color='b', linewidth=1.5, label='S1')
    else:
        plt.plot(plot_0_0_0[k], plot_0_0_1[k], color='b', linewidth=1.5)
for k in range(len(plot_0_0_0)):
    if k == 0:
        plt.plot(plot_0_0_0[k], plot_0_1_1[k], color='g', linewidth=1.5, label='S2')
    else:
        plt.plot(plot_0_0_0[k], plot_0_1_1[k], color='g', linewidth=1.5)
for k in range(len(plot_0_0_0)):
    if k == 0:
        plt.plot(plot_0_0_0[k], plot_0_2_1[k], color='r', linewidth=1.5, label='S1')
    else:
        plt.plot(plot_0_0_0[k], plot_0_2_1[k], color='r', linewidth=1.5)
for k in range(len(plot_0_0_0)):
    if k == 0:
        plt.plot(plot_0_0_0[k], plot_0_3_1[k], color='c', linewidth=1.5, label='S2')
    else:
        plt.plot(plot_0_0_0[k], plot_0_3_1[k], color='c', linewidth=1.5)
plt.title('plot_0')
plt.legend()
plt.show()
