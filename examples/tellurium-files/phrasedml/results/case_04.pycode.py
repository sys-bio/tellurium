"""
    ...
    auto-generated code
    sedmlDoc: L1V2  
    workingDir: /home/mkoenig/git/tellurium/examples/tellurium-files/phrasedml/results/_te_case_04
...
workingDir = r'/home/mkoenig/git/tellurium/examples/tellurium-files/phrasedml/results/_te_case_04'
...
for k in range(plot_0_0_0.shape[1]):
    if k == 0:
        plt.plot(plot_0_0_0[:,k], plot_0_4_1[:,k], marker = '.', color='c', linewidth=1.5, markersize=3.0, alpha=0.8, label='task3.S1')
    else:
        plt.plot(plot_0_0_0[:,k], plot_0_4_1[:,k], marker = '.', color='c', linewidth=1.5, markersize=3.0, alpha=0.8)
for k in range(plot_0_0_0.shape[1]):
    if k == 0:
        plt.plot(plot_0_0_0[:,k], plot_0_5_1[:,k], marker = '.', color='y', linewidth=1.5, markersize=3.0, alpha=0.8, label='task3.S2')
    else:
