...
plot_1_0_1 = __var__repeat2_____S1
...
plot_1_1_1 = __var__repeat2_____S2
...
for k in range(plot_1_0_0.shape[1]):
    if k == 0:
        plt.plot(plot_1_0_0[:,k], plot_1_0_1[:,k], '-o', color='r', linewidth=1.5, markersize=4.0, alpha=0.8, label='repeat2.S1')
    else:
        plt.plot(plot_1_0_0[:,k], plot_1_0_1[:,k], '-o', color='r', linewidth=1.5, markersize=4.0, alpha=0.8)
for k in range(plot_1_0_0.shape[1]):
    if k == 0:
        plt.plot(plot_1_0_0[:,k], plot_1_1_1[:,k], '-o', color='b', linewidth=1.5, markersize=4.0, alpha=0.8, label='repeat2.S2')
    else:
